...
def analyze_results(filename='/home/marcin/vm_shared/results/results_real_robot_no_obstacle.npz', output_dir='plots'):
...
if __name__ == '__main__':
    analyze_results(r'/home/marcin/vm_shared/results/results_real_robot_no_obstacle.npz')
